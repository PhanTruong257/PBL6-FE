                      ...
                      <div className="flex flex-col items-center space-y-4">
                        ...
                        <div className="text-center">
                          <h3 className="font-semibold text-lg">
                            {profile?.data ? `${profile.data.full_name}` : 'Ngô Văn Danh'}
                          </h3>
                      ...
                      <div>
                        ...
                        <div className="space-y-2 mt-2">
                          <div>
                            ...
                            <p className="text-sm">{profile?.data?.email || 'duy.danh@student.edu.vn'}</p>
                          </div>
                          <div>
                            <Label className="text-xs">Điện thoại</Label>
                            <p className="text-sm">{profile?.data?.phone || '0987 654 321'}</p>
                          </div>
                        </div>
                      </div>
                    </CardContent>
