  ...
  return (
    <div className="bg-card border rounded-lg p-4 space-y-3">
      ...
      <div className="space-y-2">
        ...
        <StatRow label={t('stats.multipleChoice')} value={stats.multipleChoice} />
      ...
      <div className="pt-3 border-t space-y-2">
        ...
        <StatRow label={t('stats.easy')} value={stats.easy} color="text-green-600" />
        <StatRow label={t('stats.medium')} value={stats.medium} color="text-yellow-600" />
        <StatRow label={t('stats.hard')} value={stats.hard} color="text-red-600" />
      </div>
    </div>
  )
}
