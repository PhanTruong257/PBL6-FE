...
export interface ServerToClientEvents {
    ...
    [SOCKET_EVENTS.MESSAGE_STATUS_UPDATED]: (data: MessageStatusUpdatedResponse) => void;
    [SOCKET_EVENTS.MESSAGE_ERROR]: (data: MessageErrorResponse) => void;
    [SOCKET_EVENTS.CONVERSATION_JOINED]: (data: ConversationJoinedResponse) => void;
...
export interface ClientToServerEvents {
    ...
    [SOCKET_EVENTS.LEAVE_CONVERSATION]: (payload: LeaveConversationPayload) => void;
